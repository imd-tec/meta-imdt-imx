...
filename=camera1-`date +%Y-%m-%d-%H-%M-%S`.jpg

gst-launch-1.0 -q v4l2src device=/dev/video3 num-buffers=3 ! video/x-raw,width=4096,height=3120 ! jpegenc ! multifilesink location=$output_path/$filename
